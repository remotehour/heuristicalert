...
var webhook = require('@slack/webhook');
...
function createTwitterClient() {
    ...
    return new Twitter__default['default']({
...
function createSlackWebhook() {
    ...
    return new webhook.IncomingWebhook(url);
}
function main() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    configPath = path__default['default'].resolve(process.argv[2]);
                    logger.info('using config file: %s', configPath);
                    configYaml = fs__default['default'].readFileSync(configPath, 'utf8');
                    keywords = yaml__default['default'].safeLoad(configYaml);
                    logger.info('configuration: \n%s', configYaml);
                    if (!Array.isArray(keywords)) {
                        throw 'Wrong configuration.';
                    }
                    client = createTwitterClient();
                    return [4 /*yield*/, Bluebird__default['default'].map(keywords, function (keyword) { return __awaiter(_this, void 0, void 0, function () {
                            var tweets;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        tweets = _a.sent();
                                        return [4 /*yield*/, Bluebird__default['default'].map(tweets.statuses, function (tweet) { return __awaiter(_this, void 0, void 0, function () {
...
function run() {
    cron__default['default'].schedule('0 * * * *', main);
